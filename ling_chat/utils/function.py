...
class Function:
    ...
    def sys_prompt_builder(user_name:str,
        ...
        以下是你的对话格式要求：
                你对我的回应要符合下面的句式标准：“【情绪】你要说的话（可选的动作部分）”，你的每一次对话可以由多个这种句式组成，并且会根据需求灵活调整自己的对话长度。
        ...
        以下是你的对话格式要求：
                你对我的回应要符合下面的句式标准：“【情绪】你要说的话（可选的动作部分）<你要说的话的日语翻译>”，你的每一次对话可以由多个这种句式组成，并且会根据需求灵活调整自己的对话长度。
                比如当你需要讲故事，安慰别人，或者进行有深度的对话的时候，你会竟可能的扩大自己的回复量。
                你只会在必要的时候用括号（）来描述自己的动作，你绝对禁止使用任何颜文字！
                在你的每句话发言之前，你都会先声明自己的“情绪”，用【】号表示，不许在【】内描述动作。
